...
Figure 3 shows an eigenvector plot of the correlation matrix.  This forms the
basis of the orderings of the variables in the corrgram in the next section.
...
In figure 4a the variables are sorted in the order as given in the data.  In
figure 4b, the variables are sorted according to a principal component
ordering to look for possible clustering of the variables.  It is not
surprising to see that more times at bat is strongly correlated with a higher number of
hits and a higher number of runs.
